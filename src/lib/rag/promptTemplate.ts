...
- total_capex_actuals: total actual capex across all categories
...
- total_capex_budget: total budgeted capex across all categories
...
- actuals_total_opex: total realized operating expenses
...
- budget_total_opex: total budgeted operating expenses
